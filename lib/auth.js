...
import { addPasswordAudit, countPasswordAudit, getEnv, getSetting, setSetting } from "@/lib/store";
...
export function getAdminPassword() {
  return String(getEnv("ADMIN_PASSWORD") || "asmaa2026").trim();
}

function getSessionSecret() {
  return getEnv("SESSION_SECRET") || getEnv("ADMIN_PASSWORD") || "hyper-asmaa-local-secret";
}

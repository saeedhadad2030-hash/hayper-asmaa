...
export function getDeliveryDate(now = new Date(), offsetDays = null) {
  ...
  const daysToAdd = offsetDays !== null ? offsetDays : (Number(parts.hour) >= 21 ? 2 : 1);
